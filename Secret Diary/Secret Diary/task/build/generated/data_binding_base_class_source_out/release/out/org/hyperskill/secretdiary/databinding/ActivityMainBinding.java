...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView hdrSecretDiary;

  @NonNull
  public final TextView tvDiary;

  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnSave,
      @NonNull Button btnUndo, @NonNull EditText etNewWriting, @NonNull TextView hdrSecretDiary,
      @NonNull TextView tvDiary) {
    this.rootView = rootView;
    this.btnSave = btnSave;
    this.btnUndo = btnUndo;
    this.etNewWriting = etNewWriting;
    this.hdrSecretDiary = hdrSecretDiary;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.hdrSecretDiary;
      TextView hdrSecretDiary = ViewBindings.findChildViewById(rootView, id);
      if (hdrSecretDiary == null) {
        break missingId;
      }
